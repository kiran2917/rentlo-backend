      ...
      <div className="relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
          ...
          >
            ...
            <h3 className="text-3xl font-black text-emerald-600 relative z-10">
              ...
              return b ? (
                <div className="mb-6 p-4 rounded-xl border bg-slate-50">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-lg font-black text-emerald-600">₹{parseFloat(b.total_amount).toLocaleString("en-IN")}</span>
                  </div>
