                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {cleanPhone && (
                            <a
                              ...
                              className="px-2.5 py-1 bg-black hover:bg-black text-white rounded-lg text-[11px] font-black flex items-center gap-1 shadow-xs"
                            >
                            ...
                            <div className="grid grid-cols-2 gap-1.5 pt-1.5 border-t border-slate-200/60">
                              ...
                              {cleanPhone && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="py-1.5 px-2 bg-black hover:bg-black text-white rounded-lg text-[11px] font-black flex items-center justify-center gap-1 shadow-xs transition-all"
