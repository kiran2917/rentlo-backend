...
# The prompt mentioned "PostgreSQL as the database" but since it was not specified whether to use local pg, I will use postgres via env vars, falling back to sqlite if not provided for testing.
