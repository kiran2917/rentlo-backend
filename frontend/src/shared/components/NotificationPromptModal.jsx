...
export const NotificationPromptModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-3 sm:p-4 bg-black/75 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-md bg-slate-900 border border-indigo-600/40 rounded-3xl p-6 sm:p-7 shadow-2xl text-white transform transition-all animate-scaleUp overflow-hidden">
        ...
        <div className="flex items-center gap-3.5 mb-3 pr-8">
          ...
          <div>
            <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-black uppercase tracking-wider ${
              isOwner ? "bg-amber-500/20 text-amber-300 border border-amber-500/30" : "bg-black/20 text-emerald-300 border border-indigo-600/30"
            }`}>
