                ...
                <div className="flex-1 overflow-y-auto pr-2 grid grid-cols-1 md:grid-cols-2 gap-3 auto-rows-max">
                  ...
                  {localities.length === 0 && (
                    <div className="col-span-full py-12 text-center">
                      ...
                      <button 
                        onClick={fetchSuggestions}
                        className="text-indigo-600 font-bold text-[14px] mt-2 hover:underline cursor-pointer"
                      >
              ...
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-emerald-50 to-teal-50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] text-indigo-600 font-medium">{selectedCity?.name} Localities</p>
                  </div>
                </div>
                      ...
                      return (
                        <label 
                          ...
                          className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-colors border ${
                            ...
                            : selectedSuggestions[name] ? "bg-white border-indigo-600 shadow-sm" : "bg-white border-slate-100 hover:border-slate-300"
                          }`}
                        >
                          <input 
                            type="checkbox" 
                            className="w-5 h-5 rounded-md text-indigo-600 focus:ring-emerald-500 border-slate-300 cursor-pointer"
