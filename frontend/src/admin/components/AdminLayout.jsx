...
export const AdminLayout = ({ children, activeTab }) => {
  ...
  const navItems = [
    ...
    { id: "earnings", label: "Earnings Log", icon: "payments", path: "/admin/earnings", roles: ["admin"] },
    { id: "payouts", label: "Agent Payouts", icon: "account_balance_wallet", path: "/admin/payouts", roles: ["admin"] },
        ...
        <Link to="/" className="flex items-center gap-2.5">
          {platformSettings?.company_logo_url ? (
            <img 
              ...
              alt={platformSettings?.company_name || "Company Logo"} 
