      ...
      <div className="relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <div className="flex justify-between items-start mb-5 relative z-10">
              <div
                className="w-14 h-14 rounded-2xl flex items-center justify-center text-indigo-600 shadow-sm border group-hover:animate-bounce transition-all duration-500"
                style={{ backgroundColor: "var(--surface-alt)", borderColor: "var(--border)" }}
              >
                <span className="material-symbols-outlined text-[28px] group-hover:text-indigo-600 transition-colors">
                  payments
                </span>
              </div>
            </div>
                ...
                <tbody className="divide-y" style={{ borderColor: "var(--border)" }}>
                  {data.tables.agents_ranked.map((a) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-[13px] font-extrabold text-indigo-600">
                        {a.approved_count}
                      </td>
                      <td className="px-6 py-4">
                        {a.trust_score !== null ? (
                          <span
                            className={`inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-widest border shadow-sm ${a.trust_score >= 80 ? "bg-black/10 text-indigo-600 border-indigo-600/20" : a.trust_score >= 50 ? "bg-amber-500/10 text-amber-500 border-amber-500/20" : "bg-red-500/10 text-red-500 border-red-500/20"}`}
                          >
                            {a.trust_score}%
                          </span>
                        ) : (
