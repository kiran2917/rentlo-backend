      ...
      <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-300">
        ...
        {isAdmin ? (
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="p-5 rounded-2xl border shadow-sm flex flex-col justify-between" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <span className="text-[11px] font-bold uppercase tracking-widest text-indigo-600 flex items-center gap-1">
                <span className="material-symbols-outlined text-[15px]">person</span> Owner Listed
              </span>
              <span className="text-2xl font-extrabold text-indigo-600 mt-2">{ownerCount}</span>
            </div>
            <div className="p-5 rounded-2xl border shadow-sm flex flex-col justify-between" style={{ backgroundColor: "var(--surface)", borderColor: "var(--border)" }}>
              <span className="text-[11px] font-bold uppercase tracking-widest text-indigo-600">Live Properties</span>
              <span className="text-2xl font-extrabold text-indigo-600 mt-2">{liveCount}</span>
            </div>
          </div>
        ) : (
                    ...
                    {paginatedProperties.map((p) => {
                      ...
                      return (
                        <React.Fragment key={p.id}>
                          ...
                          <td className="py-4 px-6">
                            {p.status === "live" && (
                              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-extrabold bg-black/10 text-indigo-600 border border-indigo-600/20">
                            ...
                            <div className="flex items-center justify-end gap-2" onClick={(e) => e.stopPropagation()}>
                              ...
                              {p.status === "under_negotiation" && (
                                <button
                                  ...
                                  className="px-2.5 py-1.5 rounded-lg bg-black/10 hover:bg-black/20 text-emerald-400 border border-indigo-600/20 text-[11px] font-bold transition-all"
                                ...
                                <div className="flex-1">
                                  ...
                                  {(p.property_category === 'pg' || p.property_type?.includes('pg')) && (
                                    <div className="flex items-center gap-2 flex-wrap mb-3">
                                      ...
                                      <span className="text-[11px] font-black px-2.5 py-1 rounded-full bg-black/15 text-emerald-300 border border-indigo-600/30">
                                  ...
                                  <div className="flex gap-4">
                                    <a href={`/property/${p.id}`} target="_blank" rel="noreferrer" className="text-indigo-600 text-xs font-bold hover:underline flex items-center gap-1">
                    ...
                    <div key={p.id} className="p-4 space-y-3.5 transition-colors hover:opacity-95" style={{ backgroundColor: "var(--surface)" }}>
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {(p.property_category === 'pg' || p.property_type?.includes('pg')) && (
                            <div className="mt-2 flex flex-wrap gap-1">
                              ...
                              <span className="text-[9px] font-black px-2 py-0.5 rounded-full bg-black/15 text-emerald-300 border border-indigo-600/30">
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-[12px] pt-3 border-t border-dashed" style={{ borderColor: "var(--border)" }}>
                        ...
                        <div>
                          ...
                          {p.status === "live" && (
                            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-black/10 text-indigo-600 border border-indigo-600/20">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t" style={{ borderColor: "var(--border)" }}>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {p.status === "under_negotiation" && (
                            <button
                              onClick={() => handleUpdateStatus(p.id, "live")}
                              className="px-2.5 py-1.5 bg-black/10 text-emerald-400 border border-indigo-600/20 hover:bg-black/20 rounded-lg text-[11px] font-bold shadow-xs transition-all cursor-pointer animate-pulse"
                            >
                              Release Hold
                            </button>
                          )}
                          ...
                          {p.status === "rented" && (
                            <button
                              onClick={() => handleUpdateStatus(p.id, "live")}
                              className="px-2.5 py-1.5 bg-black/10 text-emerald-400 border border-indigo-600/20 hover:bg-black/20 rounded-lg text-[11px] font-bold shadow-xs transition-all cursor-pointer"
                            >
                              Relist
                            </button>
                          )}
