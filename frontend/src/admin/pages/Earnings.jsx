      ...
      <div className="relative z-10 w-full">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4">
          <div className="flex items-center gap-4 group">
            <div className="w-14 h-14 bg-black/10 text-indigo-600 border border-indigo-600/20 rounded-2xl flex items-center justify-center shadow-sm group-hover:scale-110 transition-all duration-500">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
            <div className="relative group flex-1 min-w-[200px] md:w-72">
              <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-[18px] group-focus-within:text-indigo-600 transition-colors">
                search
              </span>
              <input
                className="pl-11 pr-4 py-3 w-full border rounded-xl text-[13px] font-bold outline-none focus:border-indigo-600 focus:ring-4 focus:ring-emerald-500/10 transition-all shadow-sm"
          ...
          <div className="flex flex-wrap sm:flex-nowrap gap-3 items-center w-full">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <select
                ...
                className="rounded-xl px-3 py-2 text-[13px] font-bold outline-none cursor-pointer border focus:border-indigo-600 flex-1 sm:flex-initial"
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <input
                ...
                className="rounded-xl px-3 py-2 text-[13px] font-bold outline-none border focus:border-indigo-600 flex-1 sm:flex-initial w-full sm:w-auto"
                style={{ backgroundColor: "var(--surface-alt)", color: "var(--ink)", borderColor: "var(--border)" }}
              />
                      ...
                      >
                        <td className="px-6 py-5 text-center">
                          {entry.status === "approved" && (
                            <input
                              type="checkbox"
                              className="w-4 h-4 cursor-pointer rounded text-indigo-600 focus:ring-emerald-500"
                        ...
                        <td className="px-6 py-5 font-extrabold text-[15px] text-indigo-600">
                          &#8377;{entry.amount}
                        </td>
                        <td className="px-6 py-5">
                          <span
                  ...
                  <div key={entry.id} className="p-4 space-y-3" style={{ backgroundColor: "var(--surface)" }}>
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <span className="font-extrabold text-[15px] text-indigo-600 block">&#8377;{entry.amount}</span>
                        <span
